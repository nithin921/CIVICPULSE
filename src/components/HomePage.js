                      ...
                      <div className="flex-1 min-w-0 space-y-2">
                        <div className="flex items-start justify-between">
                          ...
                          <div className={`w-3 h-3 rounded-full animate-pulse flex-shrink-0 ${
                            ...
                            report.status === 'in_progress' ? 'bg-blue-400' :
                            'bg-green-400'
                          }`}></div>
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-1">
                          <span className={`px-2 py-1 text-xs rounded-full font-medium shadow-soft flex-shrink-0 ${
                            report.status === 'pending' ? 'bg-gradient-to-r from-yellow-400 to-orange-400 text-white' :
                            report.status === 'in_progress' ? 'bg-gradient-to-r from-blue-400 to-indigo-400 text-white' :
