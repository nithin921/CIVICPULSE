              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="report-form-input w-full px-4 py-3 glass-morphism backdrop-blur-xl text-white placeholder-blue-200 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-accent-blue transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="report-form-input w-full px-4 py-3 glass-morphism backdrop-blur-xl text-white placeholder-blue-200 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-accent-blue transition-all resize-none"
                ...
                {/* Photo Upload */}
                <div>
                  <label className="block text-white text-sm font-medium mb-4 flex items-center">
